...
<html>
  <head>
    ...
    <title>Admin | Show Refunded Users</title>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('/admin/showusers') }}"><i class="fa fa-circle-o"></i>Show buldings </a></li>
                <li><a href="{{ url('/admin/adduser') }}"><i class="fa fa-circle-o"></i> Add duilding</a></li>
              </ul>
            </li>
           <!--  -->
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                     @foreach($refundings as $refunding)
                      <tr>
                        <td>{{ $refunding->name    }}</td>
                        <td>{{ $refunding->payer_email   }}</td>
                        <td>{{ $refunding->payment_id    }}</td>
                        <td>{{ $refunding->payer_id  }}</td>
                        <td>{{ $refunding->created_at    }}</td>
                        <td>{{ $refunding->refunded    }}</td>
                        </form>
                      </tr>
                       @endforeach
                        </tbody>
